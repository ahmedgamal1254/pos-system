  ...
  return (
    <div className="space-y-10 p-6 grid grid-cols-1 md:grid-cols-2 gap-2">
      ...
      <section>
        ...
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={salesData[selectedYear]}>
            <defs>
            ...
            <Tooltip />
            <Area type="monotone" dataKey="sales" stroke="#10b981" fillOpacity={1} fill="url(#colorSales)" name="المبيعات" />
            <Area type="monotone" dataKey="cost" stroke="#f87171" fillOpacity={1} fill="url(#colorCost)" name="المصروفات" />
          </AreaChart>
        </ResponsiveContainer>
      </section>
    </div>
